...
menu_layout = [['File',['New','Open','Save','Save As','---','Exit']],
               ['Edit',['Undo','---','Cut','Copy','Paste','Find...','Replace...','Select All','Time/Date']],
               ['Format',['Font','Theme',themes]],
               ['Run',['Run Module']],
               ['Help',['View Help','---','About Izzypad 1.0']]]

col1 = sg.Column([[sg.Multiline(font=('Consolas', 12), key='_BODY_', auto_size_text=True, size=(150,20))]])
...
window = sg.Window('TextCode Editor', window_layout, resizable=True, margins=(0,0), return_keyboard_events=True, finalize=True, size=(900,600))
